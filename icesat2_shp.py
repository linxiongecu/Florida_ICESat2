...
#####python icesat2_shp.py  C:/Users/xiongl21/WorkingFolder/Postdoc/Icesat2/MyTutorial/FloridaData --variables [latitude,longitude,h_canopy] --outFormat geojson
...
def gedi_to_vector(file,variables=None,outFormat='CSV',filterBounds=None):
    ...
    for k in list(data.keys()):
        ...
        if 'gt' in k:
            ...
            if ('land_segments' not in list(data[k].keys())): continue
